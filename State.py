...
class BoundedUniformPrior(Prior):
	...
	def sample(self,nSamples=1):
		...
		res = np.empty((2,nSamples))
		res[0,:],res[1,:] = numpy.random.uniform(self._bottomLeftCorner[0],self._topRightCorner[0]),numpy.random.uniform(self._bottomLeftCorner[1],self._topRightCorner[1],nSamples)
